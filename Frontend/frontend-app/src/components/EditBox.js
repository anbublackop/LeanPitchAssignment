...
function EditBox(props) {
    ...
    const getDatafromChild = (modules) => {
    ...
    const publishModule = async (module) => {
        ...
        bodyFormData.append('id', module.id)
        bodyFormData.append('new_name', module.draft_version);
        bodyFormData.append('state', "Published");
    ...
    const updateCourse = async (state) => {
        ...
        if (state == "Published") {
            moduleData.forEach(async (module) => {
                if (module.name !== undefined && module.draft_version !== undefined && module.state == "Published") {
            ...
            <div className="box">
                ...
                <Grid container className={classes.gridStyle} spacing={2}>
                    <>
                        ...
                        <Grid item xs={12} className={classes.paper}>
                            <ModuleListing sendData={getDatafromChild} data={{ clickedCourse, courseModules }} />
                        </Grid>
                    </>
                    {apiResponse}
                </Grid>
